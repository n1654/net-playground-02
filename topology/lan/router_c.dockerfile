...
!\n\
ip route 10.1.1.0/24 10.1.3.101\n\
...
RUN echo -e "#!bin/sh\n\
\n\
ip tunnel add gre-02 mode gre remote 10.1.1.102 local 10.1.3.102 ttl 255\n\
ip link set gre-02 up\n\
ip addr add 192.168.254.4 dev gre-02\n\
ip r a 192.168.99.1/32 dev gre-02\n\
\n\
